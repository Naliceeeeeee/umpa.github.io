...
ABOUT_US_PROGRAMS_SECTION = f"""
  ...
  <section class="page-block page-block--alt" id="adminProgramsFeed" hidden>
    <div class="page-block-inner">
      <h2 class="page-section-title">Latest Programs &amp; Updates</h2>
      <div class="admin-feed-grid" id="adminProgramsGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
    </div>
  </section>
"""

PROGRAMS_PARENT = ("about-us.html#programs", "Programs")
    ...
    <div class="core-values-inner">
      ...
      <div class="core-values-grid">
        <article class="core-values-card">
          ...
          <h3>Human Dignity</h3>
          <p>Every Human person has inherent worth because they are created in the image and likeness of God.</p>
        </article>
        <article class="core-values-card">
          <div class="core-values-icon" aria-hidden="true"><i class="fa-solid fa-heart-pulse"></i></div>
          <h3>Right to Life</h3>
          <p>The most fundamental human right from which all others flow.</p>
        </article>
        <article class="core-values-card">
        ...
        <article class="core-values-card">
          ...
          <p>Caring and serving others with kindness.</p>
        </article>
      </div>
    </div>
  </section>
...
ABOUT_US_REDIRECTS = {
    "who-we-are.html": "about-us.html",
    "leadership.html": "about-us.html#leadership",
  "what-we-do.html": "about-us.html#programs",
}
...
dropdown_pages = {
    "awareness-campaigns.html": {
      ...
      <section class="page-block page-block--alt" id="adminAwarenessCampaignsFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">Campaign Updates &amp; Highlights</h2>
        <div class="admin-feed-grid" id="adminAwarenessCampaignsGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "pro-life-clubs.html": {
      ...
      <section class="page-block page-block--alt" id="adminProLifeClubsFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">Club Updates &amp; Highlights</h2>
        <div class="admin-feed-grid" id="adminProLifeClubsGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "counseling-family-guidance.html": {
      ...
      <section class="page-block page-block--alt" id="adminCounselingFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">Counseling Updates &amp; Guidance</h2>
        <div class="admin-feed-grid" id="adminCounselingGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "natural-family-planning.html": {
      ...
      <section class="page-block page-block--alt" id="adminNfpFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">NFP Updates &amp; Classes</h2>
        <div class="admin-feed-grid" id="adminNfpGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "charity-outreach.html": {
      ...
      <section class="page-block page-block--alt" id="adminCharityFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">Outreach Updates &amp; Reports</h2>
        <div class="admin-feed-grid" id="adminCharityGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "training-programs.html": {
        ...
        "parent": PROGRAMS_PARENT,
        "body_html": """
      <p>We run workshops and training programs for ambassadors, catechists, and leaders equipped with knowledge and skills to advance the pro-life mission in their communities.</p>
      
      <section class="page-block page-block--alt" id="adminTrainingFeed" hidden style="padding: 2rem 0; margin-top: 2rem; border-top: 1px solid rgba(11, 37, 69, 0.08);">
        <h2 class="page-section-title" style="margin-bottom: 1.5rem;">Training Updates &amp; Workshops</h2>
        <div class="admin-feed-grid" id="adminTrainingGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;"></div>
      </section>
        """,
    },
    "upcoming-events.html": {
      ...
      <section class="events-portal-toolbar" aria-label="Filter events" style="margin-top: 3rem; margin-bottom: 2rem;">
        <div class="events-portal-inner">
          <div class="events-portal-filters" role="tablist" style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center;">
            <button type="button" class="events-portal-filter is-active" data-filter="all" role="tab" aria-selected="true">All</button>
            <button type="button" class="events-portal-filter" data-filter="conventions" role="tab" aria-selected="false">Conventions</button>
            <button type="button" class="events-portal-filter" data-filter="clubs" role="tab" aria-selected="false">Pro-Life Clubs</button>
            <button type="button" class="events-portal-filter" data-filter="outreach" role="tab" aria-selected="false">Outreach</button>
            <button type="button" class="events-portal-filter" data-filter="training" role="tab" aria-selected="false">Training</button>
            <button type="button" class="events-portal-filter" data-filter="media" role="tab" aria-selected="false">Media</button>
          </div>
        </div>
      </section>

      <section class="events-portal-grid-section" aria-label="Events list">
        <div class="events-portal-inner">
          <div class="events-portal-grid" id="eventsPortalGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 24px;">
            <!-- Dynamic events will render here -->
          </div>
          <p class="events-portal-empty" id="eventsPortalEmpty" hidden style="text-align: center; color: #64748b; padding: 2rem;">No events in this category yet.</p>
        </div>
      </section>
        """,
    },
...
pages = {
    ...
    "resources.html": {
        ...
        "extra": """
        <section class="events-portal-toolbar" aria-label="Filter resources" style="margin-top: 2rem; margin-bottom: 2rem;">
          <div class="events-portal-inner">
            <div class="events-portal-filters resources-portal-filters" role="tablist" style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center;">
              <button type="button" class="events-portal-filter is-active" data-filter="all" role="tab" aria-selected="true">All</button>
              <button type="button" class="events-portal-filter" data-filter="guides" role="tab" aria-selected="false">Guides</button>
              <button type="button" class="events-portal-filter" data-filter="pdf" role="tab" aria-selected="false">PDFs</button>
              <button type="button" class="events-portal-filter" data-filter="clubs" role="tab" aria-selected="false">Clubs &amp; Schools</button>
              <button type="button" class="events-portal-filter" data-filter="family" role="tab" aria-selected="false">Family &amp; NFP</button>
            </div>
          </div>
        </section>

        <section class="events-portal-grid-section" aria-label="Resource downloads">
          <div class="events-portal-inner">
            <div class="events-portal-grid" id="resourcesPortalGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 24px;">
              <!-- Dynamic resource cards will be loaded here -->
            </div>
            <p class="events-portal-empty" id="resourcesPortalEmpty" hidden style="text-align: center; color: #64748b; padding: 2rem;">No resources in this category yet.</p>
          </div>
        </section>
        """,
    },
...
def build_about_us_page():
    data = {
        "title": "About Us",
        "description": "About UMPA — who we are, team, and what we do.",
        "banner": "About Us",
...
{ABOUT_US_JOURNEY_SECTION}
  ...
  <section class="page-block page-block--alt" id="background">
    <div class="page-block-inner page-prose">
      <h2 class="page-section-title">Background</h2>
      <p>Uganda Martyrs Pro-life Apostolate (UMPA) is a Christian organization that promotes and defends human life from conception until natural death.</p>
      <p>UMPA was founded by Archbishop Dr. Cyprian Kizito Lwanga in response to the growing culture of death and high rates of abortion in Uganda.</p>
      <p>The organization addresses all behaviors and practices that put the dignity of the human person at risk; these include:</p>
      <ul class="background-issues-list">
        ...
        <li>And other behaviours that promote the culture of death</li>
      </ul>
    </div>
  </section>

  <section class="page-block" id="who-we-reach">
    <div class="page-block-inner page-prose">
      ...
      <div class="umpa-custom-table-wrapper mt-4">
        <table class="umpa-custom-table">
          <thead>
            <tr>
              <th scope="col" style="width: 35%;">Target Group</th>
              <th scope="col">Details &amp; Context</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <i class="fa-solid fa-graduation-cap table-icon" style="color: #8f0f0f; font-size: 1.1rem; width: 24px; margin-right: 12px;"></i>
                  <strong>Primary &amp; Secondary Schools</strong>
                </div>
              </td>
              <td>Empowering pupils and students with moral guidance and pro-life values early in their development.</td>
            </tr>
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <i class="fa-solid fa-university table-icon" style="color: #04408a; font-size: 1.1rem; width: 24px; margin-right: 12px;"></i>
                  <strong>Tertiary Institutions &amp; Universities</strong>
                </div>
              </td>
              <td>Establishing pro-life youth clubs and mentoring young adults through interactive debates.</td>
            </tr>
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <i class="fa-solid fa-church table-icon" style="color: #8f0f0f; font-size: 1.1rem; width: 24px; margin-right: 12px;"></i>
                  <strong>Churches &amp; Parishes</strong>
                </div>
              </td>
              <td>Providing spiritual nourishment, moral formation, and support within parishes, houses of formation, and faith communities.</td>
            </tr>
            <tr>
              <td>
                <div class="d-flex align-items-center">
                  <i class="fa-solid fa-briefcase table-icon" style="color: #04408a; font-size: 1.1rem; width: 24px; margin-right: 12px;"></i>
                  <strong>Corporate &amp; Workplaces</strong>
                </div>
              </td>
              <td>Engaging professional groups and corporate spaces in dialogues concerning human dignity.</td>
            </tr>
          </tbody>
        </table>
      </div>
...
{ABOUT_US_PROGRAMS_SECTION}

  <section class="page-block page-block--alt" id="leadership">
    <div class="page-block-inner page-prose">
      <h2 class="page-section-title">Team</h2>
      <p>UMPA is supported by a committed team of coordinators, chaplains, and volunteer leaders who guide programs across parishes, schools, and communities in Uganda.</p>
      ...
      <div class="leadership-team">
        ...
        <article class="leadership-card">
          <div class="leadership-card-icon" aria-hidden="true"><i class="fa-solid fa-hand-holding-heart"></i></div>
          <h3>Ms. Resty Ingabire</h3>
          <p class="leadership-role">Psychosocial Support Officer</p>
        </article>
        <article class="leadership-card">
          <div class="leadership-card-icon" aria-hidden="true"><i class="fa-solid fa-clipboard-list"></i></div>
          <h3>Ms. Josephine Kagogwe</h3>
          <p class="leadership-role">Program Officer</p>
        </article>
      </div>
...
def build_gallery_grid_html():
    ...
    for name in list_gallery_image_files():
        ...
        items.append(
            f'      <a class="photo-gallery-item gallery-portal-item" href="{src}" target="_blank" rel="noopener noreferrer" data-category="outreach">\n'
...
def build_gallery_page(data):
    ...
    grid = build_gallery_grid_html() if count else (
        '      <p class="photo-gallery-empty" id="galleryPortalEmpty">No images found in the <code>imgs</code> folder.</p>'
    )
    content = f"""
<main class="page-main gallery-portal">
  <section class="page-banner page-banner--blend">
    <div class="page-banner-photo" aria-hidden="true">
  ...
  <section class="events-portal-toolbar" aria-label="Filter gallery" style="margin-top: 2rem; margin-bottom: 2rem;">
    <div class="events-portal-inner">
      <div class="events-portal-filters gallery-portal-filters" role="tablist" style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center;">
        <button type="button" class="events-portal-filter is-active" data-filter="all" role="tab" aria-selected="true">All Photos</button>
        <button type="button" class="events-portal-filter" data-filter="outreach" role="tab" aria-selected="false">Outreach</button>
        <button type="button" class="events-portal-filter" data-filter="clubs" role="tab" aria-selected="false">Clubs &amp; Schools</button>
      </div>
    </div>
  ...
  <section class="gallery-portal-grid-section">
    <div class="events-portal-inner">
      <p class="gallery-portal-count" id="galleryPortalCount">{count} photos</p>
      <div class="gallery-portal-grid" id="galleryPortalGrid">
{grid}
      </div>
      <p class="events-portal-empty" id="galleryPortalEmpty" hidden style="text-align: center; color: #64748b; padding: 2rem;">No photos in this category yet.</p>
      <p class="gallery-portal-back" style="margin-top: 2.5rem; text-align: center;"><a href="{parent_href}" style="font-weight: 700; color: var(--hp-navy);">← Back to {parent_label}</a></p>
    </div>
  </section>
  {page_links}
</main>
...
def sync_index():
    ...
    replacements = {
        ...
        'href="what-we-do.html"': 'href="about-us.html#programs"',
        'href="about-us.html#what-we-do"': 'href="about-us.html#programs"',
        ...
        'href="#programs"': 'href="about-us.html#programs"',
...
<body class="home-page home-intro-active">
<div class="home-intro-loader" id="homeIntroLoader" role="status" aria-live="polite" aria-label="Loading UMPA homepage">
  <div class="home-intro-loader__inner">
    <img src="pasted_file_OtfQNi_image_a5ba3799.png" alt="UMPA Logo" class="home-intro-loader__logo" />
    
    <h2>Uganda Martyrs Pro-life Apostolate</h2>
    <p>Welcome. Saving life with truth, compassion, and faith.</p>
    <span class="home-intro-loader__spinner" aria-hidden="true"></span>
  </div>
</div>
"""
...
<script>
(function () {
  var loader = document.getElementById('homeIntroLoader');
  if (!loader) return;
...
# programs.html generation removed — programs are now part of about-us.html
